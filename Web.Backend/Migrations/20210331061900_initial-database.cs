...
namespace Web.Backend.Migrations
{
    public partial class initialdatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProductFileImages",
                columns: table => new
                {
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    FileImageId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductFileImages", x => new { x.FileImageId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ProductFileImages_FileImages_FileImageId",
                        column: x => x.FileImageId,
                        principalTable: "FileImages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductFileImages_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductFileImages_ProductId",
                table: "ProductFileImages",
                column: "ProductId");

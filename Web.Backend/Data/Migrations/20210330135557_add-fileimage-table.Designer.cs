...
namespace Web.Backend.Data.Migrations
{
    ...
    [Migration("20210330135557_add-fileimage-table")]
    partial class addfileimagetable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web.Backend.Models.OrderDetail", b =>
                {
                    b.HasOne("Web.Backend.Models.Order", "Order")
            ...
            modelBuilder.Entity("Web.Backend.Models.Product", b =>
                {
                    ...
                    b.HasOne("Web.Backend.Models.FileImage", "FileImage")
                        .WithOne("Product")
                        .HasForeignKey("Web.Backend.Models.Product", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
